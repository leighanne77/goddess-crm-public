...
[![CI](https://github.com/leighanne77/lynda-crm-public/actions/workflows/ci.yml/badge.svg)](https://github.com/leighanne77/lynda-crm-public/actions/workflows/ci.yml)

Voice-first team CRM **+ a deterministic warm-introduction engine** for **DIN — the Defense Investor Network.**

> **About this repository.** This is a **public, scrubbed copy** of a system that runs
> privately in production for a small defense-investor team. Client specifics, real people,
...
Lynda is a voice-first team CRM for a defense-investor network — a single-builder system
...
It's 7:40am. **Alex** opens Lynda on her phone — it's installed to the home screen like a
native app — and says: *"Who do I know at the Navy's shipbuilding office?"* Lynda reads back
three contacts, warmest first, and offers to remind her to call the top one.

Mid-morning a partner forwards a name. *"Find me a warm intro to Admiral Barrett."* Lynda
...
black box: the score is `affinity × connection ÷ hops`, and Lynda can show its work. A
...
Lynda creates it, confirms in one sentence, and quietly writes an audit row. When she asks
it to delete a duplicate, Lynda **stops and asks her to confirm first** — deletes are never
silent.

By end of day none of it felt like software. She talked; Lynda did the legwork; and the
...
Lynda is a Claude-powered assistant operating on sensitive LP/contact data, so the assurance
